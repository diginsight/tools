...
- **Sources** (practical examples):
  - [10.00-how_to_design_orchestrator_prompts.md](../../../03.00-tech/05.02-prompt-engineering/04-howto/10.00-how-to-design-orchestrator-prompts.md) — four-specialist pattern, phase-based coordination (linear, iterative, parallel), use case challenge 5-step methodology, execution flow control (iteration limits, recursion prevention, error handling)
  - [11.00-how_to_design_subagent_orchestrations.md](../../../03.00-tech/05.02-prompt-engineering/04-howto/11.00-how-to-design-subagent-orchestrations.md) — subagent mechanics, runSubagent tool patterns, context isolation examples
