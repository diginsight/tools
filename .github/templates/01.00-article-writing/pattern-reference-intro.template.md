---
description: "Introduction scaffold for reference-type articles"
---

# Pattern: Reference introduction

> Scaffold for reference articles (information-oriented). Copy, adapt, and delete the placeholder comments.
...
template_metadata:
  ...
  created: "2026-03-20"
  consumers: []
  changelog: "pattern-reference-intro.template.changelog.md"
---
-->
