...
namespace MipDocumentInspector
{
    ...
    public partial class MainWindow : WindowBase
    {
        ...
        private async void MainWindow_Initialized(object sender, EventArgs e)
        {
            ...
            {
                clientId = await ConfigurationHelper.GetClassSettingAsync<MainWindow, string>(CONFIGVALUE_CLIENTID, SettingAccessType.Secret, DEFAULTVALUE_CLIENTID); // , CultureInfo.InvariantCulture
                appName = ConfigurationHelper.GetClassSetting<MainWindow, string>(CONFIGVALUE_APPNAME, DEFAULTVALUE_APPNAME); // , CultureInfo.InvariantCulture SettingAccessType.SecretWithCredential, 
                appVersion = ConfigurationHelper.GetClassSetting<MainWindow, string>(CONFIGVALUE_APPVERSION, DEFAULTVALUE_APPVERSION); // , CultureInfo.InvariantCulture
